...
La société est implantée au sein de la pépinière des entreprises située au campus universitaire de Zarroug à Gafsa. Cette localisation lui permet d’évoluer dans un environnement favorable à l’innovation, à la collaboration avec le milieu académique et au développement de projets technologiques. Le document de présentation de TEKSIGHT précise que l’entreprise est spécialisée dans les activités informatiques et qu’elle bénéficie d’un ancrage stratégique au cœur du campus universitaire de Zarroug à Gafsa \cite{REF-TEKSIGHT}.

TEKSIGHT se positionne comme un acteur technologique régional qui contribue au développement de solutions numériques dans plusieurs domaines. Son expertise couvre notamment le développement web et mobile, les bases de données, les plateformes cloud et IoT, les systèmes embarqués ainsi que les infrastructures numériques. Le document fourni mentionne en particulier des domaines tels que le développement mobile, les systèmes embarqués, les bases de données, Firebase, Big Data et la cybersécurité \cite{REF-TEKSIGHT}.
...
\toprule
\Tcell{Élément} & \Tcell{Description} \\ \midrule
Dénomination sociale & Société TEKSIGHT \\ \lightrule
Domaine d’activité & Activités informatiques, services numériques et solutions IT \\ \lightrule
Localisation & Pépinière des entreprises, campus universitaire Zarroug, Gafsa \\ \lightrule
Identifiant fiscal & 1676402/B \\ \lightrule
Structure d’hébergement & Pépinière d’Entreprises de Gafsa \\ \lightrule
Type d’activité & Développement web et mobile, bases de données, solutions cloud, IoT et systèmes embarqués \\ \lightrule
Rôle dans le projet & Organisme d’accueil et accompagnement technique \\ \lightrule
Projet réalisé & FESTY, application mobile multiplateforme dédiée à la gestion des événements \\ \lightrule
\bottomrule
\end{tabularx}
\end{table}
...
\toprule
\Tcell{Critère} & \Tcell{Eventbrite} & \Tcell{Ticketmaster} & \Tcell{Shotgun} & \Tcell{Teskerti} & \Tcell{Facebook Events} & \Tcell{FESTY} \\ \midrule
Découverte d’événements & Oui & Oui & Oui & Oui & Oui & Oui \\ \lightrule
Création d’événements & Oui & Limitée & Oui & Limitée & Oui & Oui \\ \lightrule
Application mobile & Oui & Oui & Oui & Variable & Oui & Oui \\ \lightrule
Billetterie en ligne & Oui & Oui & Oui & Oui & Non native & Oui \\ \lightrule
Paiement en ligne & Oui & Oui & Oui & Oui & Non natif & Oui \\ \lightrule
Génération de billets numériques & Oui & Oui & Oui & Oui & Non & Oui \\ \lightrule
Validation par QR code & Oui & Oui & Oui & Variable & Non & Oui \\ \lightrule
Revente encadrée de billets & Partielle & Selon les marchés & Variable & Limitée & Non & Oui \\ \lightrule
Chat communautaire & Non & Non & Limité & Non & Discussion indirecte & Oui \\ \lightrule
Notifications personnalisées & Oui & Oui & Oui & Variable & Oui & Oui \\ \lightrule
Dashboard organisateur & Oui & Oui & Oui & Limité & Limité & Oui \\ \lightrule
Statistiques et analytics & Oui & Oui & Oui & Limité & Limité & Oui \\ \lightrule
Adaptation au marché local/arabe & Limitée & Limitée & Limitée & Partielle & Générale & Oui \\ \lightrule
\bottomrule
\end{tabular}
\normalsize
\end{table}
