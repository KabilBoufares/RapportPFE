...
\hline
\Tcell{Élément} & \Tcell{Description} \\ \hline
...
\hline
\Tcell{Critère} & \Tcell{Eventbrite} & \Tcell{Ticketmaster} & \Tcell{Shotgun} & \Tcell{Teskerti} & \Tcell{Facebook Events} & \Tcell{FESTY} \\ \hline
