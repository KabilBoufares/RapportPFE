...
Le Sprint Backlog regroupe les user stories sélectionnées pour le premier sprint. Ces fonctionnalités constituent le socle d’accès à la plateforme FESTY et permettent de sécuriser les parcours utilisateur et administrateur.
...
![Diagramme de classes partiel du Sprint 1](images/class_diagram_sprint1.png)
...
![Diagramme de séquence du scénario d’inscription](images/sequence_inscription_sprint1.png)
...
![Diagramme de séquence du scénario d’authentification](images/sequence_authentification_sprint1.png)
...
![Diagramme de séquence du scénario de gestion du profil](images/sequence_profil_sprint1.png)
...
![Diagramme de séquence du scénario d’authentification au back-office](images/sequence_admin_auth_sprint1.png)

**Figure 3.6 : Diagramme de séquence du scénario d’authentification au back-office**

## 3.4 Réalisation

Cette section présente les principales interfaces réalisées dans le cadre du Sprint 1. Ces interfaces permettent de concrétiser les fonctionnalités d’inscription, de vérification du numéro de téléphone, d’authentification, de gestion du profil utilisateur et d’accès au back-office administrateur.
...
![Interface d’inscription](images/interface_inscription.png)

**Figure 3.7 : Interface d’inscription à la plateforme**

### 3.4.2 Interface de vérification du numéro de téléphone

Après l’inscription, le visiteur est invité à saisir le code OTP reçu afin de vérifier son numéro de téléphone et d’activer son compte.

![Interface de vérification du numéro de téléphone](images/interface_verification_otp.png)

**Figure 3.8 : Interface de vérification du numéro de téléphone**

### 3.4.3 Interface d’authentification utilisateur

L’interface d’authentification permet à l’utilisateur de saisir ses identifiants afin d’accéder à son espace personnel sur la plateforme FESTY.

![Interface d’authentification utilisateur](images/interface_authentification_utilisateur.png)

**Figure 3.9 : Interface d’authentification utilisateur**

### 3.4.4 Interface de gestion du profil utilisateur
...
![Interface de gestion du profil utilisateur](images/interface_profil_utilisateur.png)

**Figure 3.10 : Interface de gestion du profil utilisateur**

### 3.4.5 Interface d’authentification administrateur
...
![Interface d’authentification administrateur](images/interface_authentification_admin.png)

**Figure 3.11 : Interface d’authentification administrateur au back-office**
